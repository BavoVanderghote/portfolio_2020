<section class="overflow-hidden">
  ...
  <div class="container__links--detail">
    ...
    <?php endif; ?>
    <?php if ($project["url_github"]): ?>
      <a class="projects__behance projects__behance--static hover--data svg-fiter" target="_blank" href="<?php echo $project["url_github"]; ?>" target="blank" data-alt="View on Github">
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1.5" y="1.5" width="27" height="27" rx="6.5" stroke="#447377" stroke-width="3"/>
